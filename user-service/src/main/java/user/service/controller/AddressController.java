...
import user.service.domain.dto.AddressDTO;
...
public class AddressController {
    ...
    public AddressDTO findAddressById(@ApiParam("地址id") @PathVariable("addressId") Long id) {
        ...
        // 2.判断当前用户
        Long userId = /* TODO UserContext.getUser();*/1L;
    ...
    public List<AddressDTO> findMyAddresses() {
        // 1.查询列表
        List<Address> list = addressService.query().eq("user_id", /* TODO UserContext.getUser();*/1L).list();
        // 2.判空
